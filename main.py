...
def main(args):
    ...
    N, K, Q, B = args.N, args.K, args.Q, args.batch_size
    ...
    # BertTokenizer.from_pretrained('./pretrain/bert-base-uncased/')
    ...
    model = ProtoNet(sentence_encoder, dot=args.dot,max_length = args.max_length,args = args)
    model.to(device)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', default='few', help='name of dataset')
    ...
    parser.add_argument('--conv_num', default=32,
                        type=int, help='the number of convolutions')
    parser.add_argument('--conv_size', default=24,
                        type=int, help='the size of convolutions')
    args = parser.parse_args()
    print('{}way {}shot Begging'.format(args.N,args.K))
    # import os
